...
const mockServices = [
  {
    ...
    short_description: 'Khám phá miền di sản với lịch trình tinh gọn, nghỉ dưỡng chỉn chu và trải nghiệm đậm bản sắc.',
  ...
  },
  {
    ...
    title: 'Nghỉ dưỡng Vịnh Hạ Long trên Du thuyền Signature Đẳng cấp',
    slug: 'nghi-duong-vinh-ha-long-du-thuyen-signature',
    short_description: 'Du thuyền chuẩn 5 sao, hải trình riêng tư giữa kỳ quan thiên nhiên nổi tiếng nhất miền Bắc.',
    ...
    duration_group: '1-3',
    transport_text: 'Du thuyền 5 sao',
  ...
  },
  {
    ...
    short_description: 'Không gian biệt thự giữa đồi thông, ẩm thực bản địa tinh tế và hành trình chậm rãi đúng chất Đà Lạt.',
  ...
  },
  {
    ...
    short_description: 'Một vòng chợ nổi buổi sớm, ẩm thực miệt vườn và nhịp sống miền Tây chân thành, mộc mạc.',
