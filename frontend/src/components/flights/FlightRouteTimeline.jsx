  ...
  return (
    <div className="flight-detail-timeline" aria-label="Lộ trình chuyến bay">
      <div className="flight-detail-timeline__point">
        ...
        <span className="flight-detail-timeline__airport">
          {flight.departure_province_label || flight.departure_airport_short_label}
        </span>
      ...
      <div className="flight-detail-timeline__point flight-detail-timeline__point--arrival">
        ...
        <span className="flight-detail-timeline__airport">
          {flight.arrival_province_label || flight.arrival_airport_short_label}
        </span>
