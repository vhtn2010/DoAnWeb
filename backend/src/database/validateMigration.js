...
const expectedIndexes = [
  ...
  'idx_user_saved_vouchers_voucher_id',
  'idx_service_reviews_service_visible',
  'idx_service_reviews_booking_id',
  'idx_service_comments_service_visible',
  'idx_service_comments_user_id',
