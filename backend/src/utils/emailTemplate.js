...
const renderEmailLayout = ({
  ...
  return [
    ...
    `<td align="right" style="font-size:12px;font-weight:700;text-transform:uppercase;color:#99f6e4;">${escapeHtml(badge || 'Thong bao')}</td>`,
    '</tr>',
    '</table>',
    '</td>',
    '</tr>',
    ...
    `Email nay duoc gui tu ${BRAND_NAME}. Neu can ho tro, vui long lien he bo phan CSKH.`,
    '</div>',
    '</td>',
    '</tr>',
    '</table>',
