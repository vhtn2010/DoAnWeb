...
VALUES
  ('profile.read_self', 'auth_profile', 'profile', 'read_self', 'Read own profile', NOW()),
  ('profile.update_self', 'auth_profile', 'profile', 'update_self', 'Update own profile', NOW()),
  ('profile.change_password', 'auth_profile', 'profile', 'change_password', 'Change own password', NOW()),
  ('user.read_all', 'user', 'user', 'read_all', 'Read all user profiles', NOW()),
  ('user.create', 'user', 'user', 'create', 'Create users', NOW()),
  ('user.update', 'user', 'user', 'update', 'Update users', NOW()),
  ('user.delete', 'user', 'user', 'delete', 'Delete users', NOW()),
  ('user.change_status', 'user', 'user', 'change_status', 'Change user status', NOW()),
  ('user.change_role', 'user', 'user', 'change_role', 'Change user role', NOW()),
  ...
  ('permission.read', 'rbac', 'permission', 'read', 'Read permissions', NOW()),
  ('role_permission.update', 'rbac', 'role_permission', 'update', 'Update role permissions', NOW()),
  ('service.read_all', 'service', 'service', 'read_all', 'Read all services', NOW()),
  ...
  ('service.inventory_update', 'service', 'service', 'inventory_update', 'Update service inventory', NOW()),
  ...
  ('booking.export', 'booking', 'booking', 'export', 'Export bookings', NOW()),
  ('payment.create_direct', 'payment', 'payment', 'create_direct', 'Create direct payments', NOW()),
  ...
  ('payment.confirm', 'payment', 'payment', 'confirm', 'Confirm payments', NOW()),
  ('payment.reject', 'payment', 'payment', 'reject', 'Reject payments', NOW()),
  ...
  ('refund.read_self', 'refund', 'refund', 'read_self', 'Read own refunds', NOW()),
  ...
  ('refund.reject', 'refund', 'refund', 'reject', 'Reject refunds', NOW()),
  ('promotion.read', 'promotion', 'promotion', 'read', 'Read promotions', NOW()),
  ...
  ('promotion.change_status', 'promotion', 'promotion', 'change_status', 'Change promotion status', NOW()),
  ('voucher.read_all', 'promotion', 'voucher', 'read_all', 'Read all vouchers', NOW()),
  ('voucher.create', 'promotion', 'voucher', 'create', 'Create vouchers', NOW()),
  ('voucher.update', 'promotion', 'voucher', 'update', 'Update vouchers', NOW()),
  ('voucher.delete', 'promotion', 'voucher', 'delete', 'Delete vouchers', NOW()),
  ('voucher.apply', 'promotion', 'voucher', 'apply', 'Apply vouchers', NOW()),
  ('support.create_ticket', 'support', 'ticket', 'create_ticket', 'Create support tickets', NOW()),
  ('support.read_self', 'support', 'ticket', 'read_self', 'Read own support tickets', NOW()),
  ('support.read_all', 'support', 'ticket', 'read_all', 'Read all support tickets', NOW()),
  ...
  ('report.read', 'admin', 'report', 'read', 'Read reports', NOW()),
  ...
  ('email.resend', 'mail', 'email', 'resend', 'Resend emails', NOW()),
  ...
  ('notification.manage', 'notification', 'notification', 'manage', 'Manage notifications', NOW()),
  ('settings.read', 'settings', 'settings', 'read', 'Read settings', NOW()),
  ('settings.update', 'settings', 'settings', 'update', 'Update settings', NOW())
ON CONFLICT (code) DO UPDATE
SET
